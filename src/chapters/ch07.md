...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch07-dorothy-cloud-security.html">Dorothy Gale Secures the Emerald City Cloud</a></p>
<p class="pbq-promo-text">Design PBQ. Map each finding in an external cloud audit to its correct control — shared responsibility, IAM scoping, container admission policy, customer-managed keys, CASB, CSPM.</p>
</div>
</div>
...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch07-dorothy-incident.html">Dorothy Reviews the Emerald City Breach</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. Seven months later, the Capital-One-shaped failure actually lands. 14.2M records exfiltrate in eleven hours. Walk backward through the CloudTrail timeline and name the specific control (including the encryption-choice reasoning) that failed at each step.</p>
</div>
</div>
