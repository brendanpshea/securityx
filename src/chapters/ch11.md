...
11. In the Marriott / Starwood breach disclosed in 2018, attackers had access to the Starwood reservation environment for approximately four years before discovery, and the initial detection came from an internal security tool alert against the Starwood database rather than from mature continuous monitoring of the inherited environment.
...
11. **True.** Four years of dwell and discovery only after an internal security tool alerted on access to the Starwood database capture the core lesson about legacy-environment blind spots.
