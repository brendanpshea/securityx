...
<p class="pbq-promo-text">Design PBQ. Map each row of an architecture-review table to its Zero Trust fix — SASE, PDP/PEP, continuous authorization, microsegmentation, classification-driven DLP, effectiveness metrics.</p>
</div>
</div>
...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch04-prospero-incident.html">Prospero Reviews the Milan Island Breach</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. The dashboard says 98% of apps are behind ZTNA. The breach went through the 2%. Walk backward through a legacy-VPN exception and name the Zero Trust principle that failed at each step.</p>
</div>
</div>
