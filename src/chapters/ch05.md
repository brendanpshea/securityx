...
<p class="pbq-promo-text">Design PBQ. Step through a hostile-offboarding playbook from an IdP account export — IdP disable, token rotation, session revocation, SSH key removal, PAM, SCIM.</p>
</div>
</div>
...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch05-emma-incident.html">Emma Reviews the Churchill Aftermath</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. The IdP kill switch worked perfectly — and 43 days later the ex-employee force-pushes a backdoor anyway. Walk backward and identify everything federation did not cover.</p>
</div>
</div>
