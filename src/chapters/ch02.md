...
- **Financial Gain:** The most common motivation. These actors deploy ransomware, steal credit card numbers, or conduct corporate extortion.
- **Geopolitical / Cyber Warfare:** State-sponsored actors attacking critical infrastructure (power grids, voting systems) to destabilize rival nations.
- **Activism (Hacktivism):** Ideologically driven attacks. A hacktivist group might deface a corporate website or leak internal emails to protest a company's environmental policies.
- **Notoriety:** Often referred to as "Script Kiddies," these actors launch attacks simply for bragging rights within hacker communities or to prove a point.
- **Espionage:** The quiet, long-term theft of intellectual property, such as stealing the blueprints for a competitor's new fighter jet.
...
> **[Warning]**
> A common flaw in legacy threat modeling is assuming the internal network is entirely "trusted." Modern adversaries exploit this by breaching a low-level employee's laptop and then moving laterally through the internal network unopposed. This is why modern architectures advocate for Zero Trust.
