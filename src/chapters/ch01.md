...
<p class="pbq-promo-text">Design PBQ. Work this one after the review to apply the chapter's concepts in scenario form — choose the right document tier, framework, and ownership tool for a brand-new program.</p>
</div>
</div>
...
<img src="../assets/images/pbq_badge.png" alt="" class="pbq-promo-badge">
<div>
<p class="pbq-promo-kicker">Diagnose The Failure</p>
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch01-snow-white-incident.html">Snow White Investigates the Doc Incident</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. Six months into the program, a $2.3M wire fraud lands anyway. Walk backward through the post-incident report and name the specific governance control that failed at each step.</p>
</div>
</div>
