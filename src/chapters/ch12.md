...
<p class="pbq-promo-text">Design PBQ. Map each open ticket in an IR queue to the right control — CVSS, SCAP/XCCDF/OVAL, SOAR playbook, malware sandbox, order of volatility.</p>
</div>
</div>
...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch12-alice-incident.html">Alice Reviews the Hare Incident</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. A 90-second automated response destroys an HR investigation in real time. Walk backward through how a working playbook can still produce the wrong outcome — and identify the runbook, scoping condition, and quality metric that should have been there.</p>
</div>
</div>
