...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch09-juliet-byod-mdm.html">Juliet Capulet Rolls Out BYOD at Verona Health</a></p>
<p class="pbq-promo-text">Design PBQ. Map each item in a CISO's pre-rollout gap memo to its control — selective wipe, containerization, conditional access, FIDO2, per-SSID VLAN, DMARC, DNSSEC.</p>
</div>
</div>
...
<p class="pbq-promo-title"><a href="https://brendanpshea.github.io/securityx/problems/ch09-juliet-incident.html">Juliet Reviews the Imaging-Department Ransomware</a></p>
<p class="pbq-promo-text">Diagnostic PBQ. The BYOD program shipped, then radiology gets ransomwared anyway — through a portal nobody locked and an enclave a vendor un-fenced with a patch cable. Walk backward through both doors.</p>
</div>
</div>
